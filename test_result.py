...
if __name__ == "__main__":
    ...
    model_path = f"LifeGPT/model_parameters/07_22_2024_Conway_2_State_Jump_Rot_Pos_On_Masking_On_Broad_Entropy_Homog_2025-04-13 05-55-52/LifeGPT_v7_epoch_34.pt"
    ...
    for temp in temperatures:
        ...
        row_indices = []
        selected_indices = list(range(2, 3))
